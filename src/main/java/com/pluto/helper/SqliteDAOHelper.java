...
public class SqliteDAOHelper {
    ...
    public static List<CodeBasic> queryCodeBasic(String condition) {
    ...
    public static List<TradeDate> queryTradeDate(String condition) {
    ...
    public static List<DayKData> queryDayKData(String condition) {
    ...
    public static List<BasicKData> queryWeekKData(String condition) {
        if (condition == null || condition.isEmpty()) {
